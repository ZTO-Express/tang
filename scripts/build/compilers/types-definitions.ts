...
import { buildOutput, zpageRoot, pkgRoot, projRoot } from '../utils/paths'
...
export const generateTypesDefinitions = async () => {
  ...
  await Promise.all([
    ...
    ...zpagePaths.map(async file => {
      const content = await fs.readFile(path.resolve(zpageRoot, file), 'utf-8')
