...
import { ts, Project, SyntaxKind, TypeNode, Type } from 'ts-morph'
...
import type { Doc, DocRef, DocTags, SchemaInfo, WidgetProperty, WidgetPropertyType, WidgetSchema } from './types'
import type { SourceFile, ProjectOptions, InterfaceDeclaration, JSDoc, TypeElementTypes } from 'ts-morph'
