...
function defaultArrayMerge(target: any[], source: any[], options?: DeepmergeOptions) {
...
export function deepmergeAll<T = any>(array: Array<Partial<T>>, options: DeepmergeOptions) {
